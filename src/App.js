...
import abi from './contracts/WaterAirCoin.json'
...
function App() {
  ...
  const contractAddress = '0xab46233dED8D2a3E8c2eFBc4Dde2C46c18D90813'
  ...
  return (
    <main className='main-container'>
      <h2 className='headline'>
        <span className='headline-gradient'>Water Air Coin Project</span>
        <img
